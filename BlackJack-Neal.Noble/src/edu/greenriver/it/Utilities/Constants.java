...
public class Constants
{
	...
	public final static String GAME_NAME = "Bacic BlackJack 2016!";
	public final static String DIVIDER = "---------------------------------------------------";
	public final static String DEALERS_NAME = "Dealer's";
	public final static String PLAYERS_NAME = "Your";
	public final static char Y = 'y';
	public final static String THANK_YOU = "Thank you for playing Basic Black Jack 2016";
}
