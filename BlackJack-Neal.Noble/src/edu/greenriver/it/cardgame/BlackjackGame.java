...
import edu.greenriver.it.cards.BlackJackHand;
import edu.greenriver.it.cards.CardDeck;
...
public class BlackjackGame extends CardGame
{
	...
	public void playRound()
	{
		...
		BlackJackHand dealerHand = new BlackJackHand(Constants.DEALERS_NAME);
		BlackJackHand playerHand = new BlackJackHand(Constants.PLAYERS_NAME);
